...
Previous installed version inspected: `metdatapy==1.1.0`.
Current implemented version: `metdatapy==1.2.0`.

## Resolved In MetDataPy 1.2.0

Status: implemented in the current codebase and covered by regression tests.
